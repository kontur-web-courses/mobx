...
![width:768px](figures/jquery-state.png)

обнови состояние, синхронизируй весь UI

---

# React-style

![width:768px](figures/react-state.png)

обнови состояние, обновится VDOM,  
посчитаются изменения, синхронизируется UI

---

# Angular-style

![width:768px](figures/angular-state.png)

обнови состояние,  
UI следит и синхронизируется

---

# RX-style

![width:512px](figures/rx-state.png)
...
на каждое изменение, сгенерируй код синхронизации UI

---

# Обратно к истокам

Хотим декларативный механизм,  
который будет звать некий код  
следя за тем, что код использует

---

# Реактивное программирование

![width:512px](figures/observable-observer.png)
...
Для массивов, Map и Set есть observable варианты
