...
// TODO: здесб будем хранить текущее изменение
...
export function box(initial) {
  ...
  return {
    ...
    observers: [],
    get() {
      // TODO: добавить обертку в список прочитанных у текущей реакции
      return value;
    },
    set(newValue) {
      value = newValue;
      // TODO: 1. скопировать текущий список наблюдателей
...
// Скрытие обертки за удобным взаимодействием с объектом
export function observable(target) {
  const keys = Reflect.ownKeys(target);
  // Заменим все свойства объекта на обертки
